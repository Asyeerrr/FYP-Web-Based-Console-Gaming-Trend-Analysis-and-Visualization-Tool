...
5. With that done, you can open any browser and go to the web address [localhost/phpmyadmin](localhost/phpmyadmin).
...
8. Now, we can go the web address [localhost/fyp/http_dir/home.php](localhost/fyp/http_dir/home.php) (or localhost/YOURFOLDERNAME/http_dir/home.php) and you can explore the web based application. 
